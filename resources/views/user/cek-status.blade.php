...
<div class="bg-gray-50 min-h-screen pt-28 pb-20 font-sans">
    <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if(request()->filled('order_id'))
            @if($participant)
                @if($participant->payment_status === 'pending' || $participant->payment_status === 'failed')
                    <div class="bg-yellow-50 border border-yellow-200 rounded-2xl p-6 text-center shadow-sm">
                        ...
                        <h2 class="text-xl font-bold text-yellow-700 mb-2">Sedang Diverifikasi</h2>
                        <p class="text-yellow-600 font-medium">Pembayaran Anda sedang dalam antrean verifikasi admin. Mohon ditunggu ya!</p>
