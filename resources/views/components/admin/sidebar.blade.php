    ...
    <nav class="mt-6 px-4 space-y-1 flex-1 overflow-y-auto">
        ...
        <div class="pt-4 pb-2">
            ...
            <div class="pl-12 pr-4 space-y-1 mt-1">
                <!-- Rute dari Annisa + Hover dari kamu -->
                <a href="{{ route('admin.datapendaftar') }}" class="block py-2 text-sm rounded-md px-3 transition {{ request()->routeIs('admin.datapendaftar*') || request()->is('admin-gsc/pendaftar*') ? 'bg-white/10 text-white font-bold' : 'text-blue-100 hover:text-white hover:bg-white/5' }}">
                    Data Pendaftar
                </a>
        ...
        <a href="{{ route('admin.faq') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg font-bold transition {{ request()->routeIs('admin.faq') ? 'bg-white/10 border-l-4 border-[#e85d04] text-white' : 'text-blue-100 hover:bg-white/10 hover:text-white border-l-4 border-transparent' }}">
