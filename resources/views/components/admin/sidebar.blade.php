...
<aside class="w-64 bg-[#0b4d75] text-white h-screen fixed left-0 top-0 z-50 shadow-xl flex flex-col">
    ...
    <div class="p-6 border-b border-blue-800/50 flex justify-center">
        <a href="{{ url('/') }}">
            <img src="{{ asset('img/logo.png') }}" alt="Logo Octoberun" class="h-10 bg-white/10 p-2 rounded-lg backdrop-blur-sm">
        </a>
    </div>
    ...
    <nav class="mt-6 px-4 space-y-1 flex-1 overflow-y-auto">
        ...
        <a href="{{ route('admin.settings') }}" class="flex items-center gap-3 px-4 py-3 text-blue-100 hover:bg-white/10 hover:text-white rounded-lg transition">
