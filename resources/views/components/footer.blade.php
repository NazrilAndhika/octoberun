        ...
        <div class="flex flex-col md:flex-row md:justify-between gap-10 md:gap-8 mb-12 text-center md:text-left">
            ...
            <div class="w-full md:w-1/4 flex flex-col items-center md:items-start">
                ...
                <div class="flex gap-4 justify-center md:justify-start">
                    <a href="https://www.instagram.com/eventoctoberun?igsi=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" class="w-8 h-8 rounded-full border border-white/30 flex items-center justify-center hover:bg-white hover:text-[#0b4d75] transition">
