...
<footer class="bg-[#0b4d75] text-white pt-16 pb-8 mt-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div class="col-span-1">
                ...
                <img src="{{ asset('img/logo.png') }}" alt="Logo Octoberun" class="h-10 mb-4 bg-white p-1 rounded shadow-sm">
                ...
                <div class="flex gap-4">
                    <a href="#" class="w-8 h-8 rounded-full border border-white/30 flex items-center justify-center hover:bg-white hover:text-[#0b4d75] transition">
            ...
            <div class="col-span-1">
                ...
                <form action="#" class="flex mt-2">
                    ...
                    <button type="submit" class="bg-white px-4 py-2 rounded-r hover:bg-gray-100 transition border-l border-gray-200">
