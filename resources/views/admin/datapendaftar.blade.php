...
<div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
    ...
    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('admin.datapendaftar.export', array_merge(request()->query(), ['export_page' => 'true', 'page' => $participants->currentPage(), 'per_page' => $participants->perPage()])) }}" id="btn-export-page"
                class="inline-flex items-center gap-2 text-sm font-semibold px-4 py-2 rounded-lg border border-amber-300 bg-white text-amber-600 hover:bg-amber-50 hover:text-amber-700 transition">
